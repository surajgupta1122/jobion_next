              ...
              <div className="px-4 sm:px-6 lg:px-8 pb-6 sm:pb-8 space-y-4 sm:space-y-5 pt-6">
                ...
                <div className="flex items-start gap-2.5 pt-2">
                  ...
                  <label htmlFor="terms-checkbox" className="text-xs sm:text-sm text-text-muted cursor-pointer leading-relaxed">
                    I agree to the{" "}
                    <Link href="/terms" target="_blank" className="text-primary-600 hover:text-primary-700 hover:underline font-medium">
                      Terms & Conditions
                    </Link>{" "}
                    and{" "}
                    <Link href="/privacy" target="_blank" className="text-primary-600 hover:text-primary-700 hover:underline font-medium">
                      Privacy Policy
                    </Link>{" "}
                    of Jobion.
                  </label>
